function generatePieGraph(t, e) {
    ...
    var o,
        ...
        d = e.hasOwnProperty("doughnutHoleColor")
            ? e.doughnutHoleColor
            : "#fff",
        ...
        k = L(e, "overlayStrokeColor")
            ? e.isStrokePie.overlayStrokeColor
            : "#eee",
        M = !L(e, "strokeAnimation") || e.isStrokePie.strokeAnimation,
        S = L(e, "strokeAnimationSpeed")
            ? e.isStrokePie.strokeAnimationSpeed
            : 10,
        y = L(e, "stroke") ? e.isStrokePie.stroke : 20,
        w = L(e, "fontSize") ? e.isStrokePie.fontSize : "50px",
    ...
    !(function e() {
        ...
        if (101 == z) {
            ...
            if (1 == f && "vertical" == P) {
                for (
                    var w = '<div class="pie-vertical-list-' + t + '"><ul>',
                    c = 0;
                    c < r.length;
                    c++
                )
